...
if (isset($_POST['simpan'])) {
    ...
    $password = md5($_POST['password_221032']); // Hashing the password
    ...
    if (mysqli_num_rows($checkNIK) > 0) {
        echo "<script>
                ...
                document.location='tambahpelanggan.php';
              </script>";
        exit;
    }
    ...
    $simpan = mysqli_query(
        ...
        VALUES 
        ('$nik', '$nama', '$username', '$password', '$alamat', '$telepon')"
    );
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <textarea name="alamat_221032" class="form-control"
                                                id="alamat" placeholder="Masukkan Alamat" required></textarea>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="telepon_221032" class="form-control"
                                                id="telepon" placeholder="Masukkan Nomor Telepon" required>
