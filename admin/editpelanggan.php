...
if (isset($_GET['hal'])) {
    if ($_GET['hal'] == 'edit') {
        $tampil = mysqli_query($koneksi, "SELECT * FROM pelanggan_221032 WHERE nik_221032 = '$_GET[id]'");
...
if (isset($_POST['simpan'])) {
    ...
    // Hash password with MD5 if not empty (for update when password is not changed)
        ...
        <div class="content-wrapper">
            ...
            <section class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1><?= isset($_GET['hal']) && $_GET['hal'] == 'edit' ? 'Edit' : 'Tambah' ?> Pelanggan</h1>
                        </div>
                        <div class="col-sm-6">
                                ...
                                <form method="POST">
                                    <div class="card-body">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="nik_221032" class="form-control"
                                                ...
                                                <?= isset($_GET['hal']) && $_GET['hal'] == 'edit' ? 'readonly' : '' ?>>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="password" name="password_221032" class="form-control"
                                                ...
                                                <?= !isset($_GET['hal']) ? 'required' : '' ?>>
                                            <small class="text-muted"><?= isset($_GET['hal']) ? 'Kosongkan jika tidak ingin mengubah password' : '' ?></small>
                                    ...
                                    <div class="card-footer">
                                        <button type="submit" id="submitButton" name="simpan" class="btn btn-primary">
                                            <?= isset($_GET['hal']) && $_GET['hal'] == 'edit' ? 'Update' : 'Simpan' ?>
                                        </button>
