...
if (isset($_GET['hal']) && $_GET['hal'] == 'hapus') {
    $hapus = mysqli_query($koneksi, "DELETE FROM layanan_221032 WHERE kode_layanan_221032 = '$_GET[id]'");
                                ...
                                <div class="card-body">
                                    ...
                                    <table id="example1" class="table table-bordered table-striped">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                <td><?= $no++ ?></td>
                                                <td><?= $data['kode_layanan_221032'] ?></td>
                                                <td><?= $data['nama_layanan_221032'] ?></td>
                                                <td>Rp. <?= number_format($data['harga_layanan_221032'], 0, ',', '.') ?></td>
                                                <td>
                                                    <a class="btn btn-warning"
                                                        href="editlayanan.php?hal=edit&id=<?= $data['kode_layanan_221032'] ?>">Edit</a>
                                                    <a class="btn btn-danger"
                                                        onclick="return confirm('Apakah Anda Yakin Ingin Menghapus Data?')"
                                                        href="layanan.php?hal=hapus&id=<?= $data['kode_layanan_221032'] ?>">Hapus</a>
                                                </td>
                                            </tr>
                                            <?php endwhile; ?>
                                        </tbody>
